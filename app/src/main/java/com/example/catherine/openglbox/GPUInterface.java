...
public class GPUInterface {
    ...
    public void drawIndexedBufferedData(Buffer vertices, Buffer indices, int stride, String attrVar) {
        if(isValid()) {
            int attrVarRef= getShaderVarRef(attrVar);
            vertices.position(0);
            indices.position(0);
    ...
    public void drawIndexedColouredBufferedData(Buffer vertices, Buffer indices, int stride, String vertexVar, Buffer colours, int cstride, String colourVar) {
        if(isValid()) {
